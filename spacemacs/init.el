  ...
  (custom-set-variables
   ...
   '(package-selected-packages
     '(a ace-link aggressive-indent alert all-the-icons auto-compile
         auto-highlight-symbol auto-yasnippet avy-jump-helm-line browse-at-remote
         centered-cursor-mode clean-aindent-mode closql code-review
         column-enforce-mode company deferred define-word devdocs diff-hl diminish
         ...
         hungry-delete hybrid-mode indent-guide info+ inspector link-hint llama
         log4e lorem-ipsum lsp-mode lsp-origami lsp-treemacs lsp-ui macrostep
         magit magit-section markdown-mode markdown-toc multi-line mwim nameless
         ...
         uuidgen vi-tilde-fringe volatile-highlights vundo wgrep winum with-editor
